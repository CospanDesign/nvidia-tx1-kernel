...
static const ov5647_reg ov5647_stop[] = {
  {0x4202, 0x0F}, /* mode select streaming on */
  {0x0100, 0x01},
  {OV5647_TABLE_END, 0x00}
};

static const ov5647_reg group_hold_off[] = {
  {0x0104, 0x00},
  {OV5647_TABLE_END, 0x00}
};
static const ov5647_reg group_hold_on[] = {
  {0x0104, 0x00},
  {OV5647_TABLE_END, 0x00}
};
...
static const ov5647_reg mode_1920x1080[] = {
  ...
  //ISP Control
  {0x5000, 0x06}, /*ISP Control:  IENC_EN: False, Defective Pixel Cancel BC_EN, WC_EN: True, True */
  {0x5002, 0x40}, /*ISP Control:  WEN_EN: True, OTP EN: False, AWB_GAIN_EN: False */
  {0x5003, 0x08}, /*DIG COMP BYPASS: DIG_COMP_BYPASS: True, MAN_OPT: False, MAN_EN: False */
  ...
  //{0x380D, 0x70},
  {0x380C, 0x07}, /* Horizontal Size: 2322 */
  {0x380D, 0x80},
  ...
  {0x3808, 0x07}, /* DVP Output Horizintal Width: 1920 */
  {0x3809, 0x80},

  {0x380A, 0x04}, /* DVP Output Vertical Height: 1080 */
  {0x380B, 0x38},

  //Windowing the Sensor
  {0x3800, 0x01}, /* X Start Address: 348 */
  {0x3801, 0x5C},
  {0x3802, 0x01}, /* Y Start Address: 434 */
  {0x3803, 0xB2},
  {0x3804, 0x08}, /* X End Address: 2275 */
  {0x3805, 0x09},
  {0x3806, 0x05}, /* Y End Address: 1521 */
  {0x3807, 0xF1},
  ...
  //{0x4800, 0x36}, /* MIPI Control: */ //???
  //{0x4800, 0x24}, /* MIPI Control: */ //???
  //{0x4800, 0x14}, /* MIPI Control: */
  //{0x4800, 0xB4}, /* MIPI Control: */	//???
...
static const ov5647_reg mode_1280x720[] = {
  ...
  //Timing
  {0x380C, 0x0B}, /* Horizontal Size: 2844 */
  {0x380D, 0x1C},

  {0x380E, 0x07}, /* Vertical Size: 1968 */
  {0x380F, 0xB0},
  ...
  {0x3808, 0x0A}, /* DVP Output Horizintal Width: 2592 */
  {0x3809, 0x20},

  {0x380A, 0x04}, /* DVP Output Vertical Height: 1944 */
  {0x380B, 0x38},

  //Windowing the Sensor
  {0x3800, 0x00}, /* X Start Address: 0 */
  {0x3801, 0x00},
  {0x3802, 0x00}, /* Y Start Address: 0 */
  {0x3803, 0x00},
  {0x3804, 0x0A}, /* X End Address: 2623 */
  {0x3805, 0x3F},
  {0x3806, 0x07}, /* Y End Address: 1955 */
  {0x3807, 0xA3},
  ...
  //ISP Offsets
  {0x3811, 0x10}, /* ISP Horizontal Offset: 16 */
  {0x3813, 0x06}, /* ISP Vertical Offset: 6 */
  ...
  {0x4837, 0x16}, /* Period of PCLK2X, PCLK_DIV = 1 and 1-bit Decimal: 22 */
  {0x4800, 0x24}, /* MIPI Control: */
                  /* BIT[7]: MIPI HS Only: False */
                          /* MIPI Supports CD and Escape Mode */
                  /* BIT[6]: CK_MARK1_EN: False */
